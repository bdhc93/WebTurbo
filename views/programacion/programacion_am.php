...
<section class="page-title">
    <div class="page-title-img bg-img bg-overlay-darken" style="background-image: url(<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_ban_am.jpg);">
        <div class="container">
            ...
            <div class="col-lg-9">
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_1.jpg" alt="gallery-img">
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_2.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_3.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_4.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_5.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_6.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_7.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_8.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
                ...
                <div class="media media-list-view media-border flex-column flex-md-row align-items-stretch mb-5">
                    <div class="media-img position-relative">
                        <img class="img-fluid position-relative" src="<?php echo constant('URL'); ?>public/images/pruebas/prog/prog_am_9.jpg" alt="gallery-img">
                        <a class="media-img-overlay" data-fancybox="gallery" href="<?php echo constant('URL'); ?>public/img/holets/hotel-list-01.jpg"></a>
                    </div>
